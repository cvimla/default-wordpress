...
<head>
 ...
 <script>
        function initMap() {
			...
			// Custom marker icon
			var customIcon = {
				url: "https://solarex.web-testserver.com/wp-content/themes/Solarex/assets/img/pinip.png", // Replace with your custom marker URL
...
})(window,document,'script','dataLayer','GTM-KMXTN67Z');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KMXTN67Z"
